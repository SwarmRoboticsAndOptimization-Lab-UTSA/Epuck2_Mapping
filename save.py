...
##############################
NUM_ROBOTS = 2 # Set this value to the number of robots to which connect
# Fill the list with the IP addresses of the robots to which connect
addr = ["192.168.1.102","192.168.1.115"]
    ...
    while True:
        ...
        while(expected_recv_packets > 0):
            ...
            if header == bytearray([1]): # Get a QQVGA image
                ...
                cv2.circle(debug_image, [120,150], 10, (0,0,255), -1) #Draw circle goal location
