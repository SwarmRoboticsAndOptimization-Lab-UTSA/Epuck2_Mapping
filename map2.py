...
def plot_grid(map_width, map_height, occupancy_grid, robot_position):
...
# The thread is responsible for: initiating and maintaining the communication; interpreting the data received and controlling the robot based on these data.
    ...
    while True:
        ...
        while(expected_recv_packets > 0):
            ...
            if header == bytearray([1]): # Get a QQVGA image
                ...
                occupancy_grid = np.full((grid_rows, grid_cols), 0.5)
                ...
                for angle, ir_reading in enumerate(ir_readings):
                    ...
                    print('normalized_distance q',normalized_distance)
                    ...
                    if 0 <= grid_row < grid_rows and 0 <= grid_col < grid_cols:
                        occupancy_grid[grid_row][grid_col] = 0.9 if normalized_distance < 0.03 else 0.1
...
while True:
    ...
    print("\r\n")
    plot_grid(map_width, map_height, occupancy_grid, robot_position)
